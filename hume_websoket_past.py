...
# === (1) HumeのAPIキー ===
API_KEY = "md9qaijjQHyURDgs2fGGrbCOJc9L5qzD5wU3y2PO54lgPWhy"  # ←あなたの「Project API Key」をここに！
...
async def stream_audio():
    ...
    async with websockets.connect(
        ...
        def callback(indata, frames, time_info, status):
            ...
            audio_buffer += indata.tobytes()

            # 0.5秒分たまったら送信
            if len(audio_buffer) >= CHUNK_SIZE * 2:  # int16は2バイト
        ...
        with sd.InputStream(
            ...
            try:
                ...
                print("WebSocket closed normally. (Timeout or no audio)")
